...
async function lerArquivoCSV() {
  try {
    const response = await fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vRXrPSCFt3oglNAbPai2jEp3LLmku6DNvIU4WlbF0RwdKOcwgFf9mwCJjOlApkOGA/pub?gid=2110176679&single=true&output=csv");
    if (!response.ok) {
